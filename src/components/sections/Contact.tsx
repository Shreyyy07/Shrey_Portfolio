      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          >
            ...
            <button
              type="submit"
              className="inline-flex items-center gap-2 rounded-xl bg-primary px-6 py-3 font-medium text-primary-foreground transition-all hover:glow-cyan hover:scale-105"
            >
          ...
          >
            {[
              ...
              <a
                key={label}
                href={href}
                className="glass-card flex items-center gap-4 rounded-xl p-4 transition-all hover:glow-cyan"
              >
